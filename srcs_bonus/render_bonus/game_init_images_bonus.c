...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   game_init_images_bonus.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: ismaelmehdid <ismaelmehdid@student.42.f    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/26 20:28:42 by ismaelmehdi       #+#    #+#             */
/*   Updated: 2024/01/29 20:22:59 by ismaelmehdi      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	game->props->enemy_image_1 = mlx_xpm_file_to_image(
			game->mlx->mlx_con,
			"./srcs_bonus/sprites/enemy/enemy1.xpm", &(game->mlx->width_image),
			&(game->mlx->height_image));
	if (game->props->enemy_image_1 == NULL)
		return (0);
	game->props->enemy_image_2 = mlx_xpm_file_to_image(
			game->mlx->mlx_con,
			"./srcs_bonus/sprites/enemy/enemy2.xpm", &(game->mlx->width_image),
			&(game->mlx->height_image));
	if (game->props->enemy_image_2 == NULL)
		return (0);
	game->props->enemy_image_3 = mlx_xpm_file_to_image(
			game->mlx->mlx_con,
			"./srcs_bonus/sprites/enemy/enemy3.xpm", &(game->mlx->width_image),
			&(game->mlx->height_image));
	if (game->props->enemy_image_3 == NULL)
		return (0);
	game->props->enemy_image_4 = mlx_xpm_file_to_image(
			game->mlx->mlx_con,
			"./srcs_bonus/sprites/enemy/enemy4.xpm", &(game->mlx->width_image),
			&(game->mlx->height_image));
	if (game->props->enemy_image_4 == NULL)
		return (0);
	return (1);
}
